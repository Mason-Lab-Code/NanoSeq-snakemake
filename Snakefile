...
rule check_contamination:
    ...
    shell:
        ...
        VerifyBamID --SVDPrefix /opt/apps/eb/software/VerifyBamID2/2.0.1-GCC-11.3.0/resource/1000g.100k.b38.vcf.gz.dat --Reference {input.hla_fa} --BamFile {input.bam} --Output 11_contamination_check/{wildcards.sample}_{wildcards.type}
        """
